import {
  ...
  function PilihBankSampah({ getDataBank, setIdBank, nmBank, setNmBank,alamatBank, setAlamatBank }) {
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Typography variant="subtitle1">
                  Pilih Pengelola 3R :{users.c_defBankName} {users.c_defBankAlamat}
                </Typography>
              </Grid>
  ...
  export default PilihBankSampah;
